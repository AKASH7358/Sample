...
names = ["Akash" , "Rahul"]
usernames = ["akashmv7358" , "rahulmv10"]
passwords = ["akmv10" , "rahmv7358"]
...
authenticator = stauth.Authenticate(names, usernames, hashed_passwords,cookie_name="streamlit",key="abcdef")
...
if authentication_status:
    ...
    MODEL_PATH ='/Users/akash/Desktop/Heart disease DL xray/image1/heart_disease_prediction1_model_resnet50.h5'
    model = load_model(MODEL_PATH)
    
    # Load your trained model
    model1 = pickle.load(open('/Users/akash/Desktop/Heart disease DL xray/tabular dataset/classifier_model1.pkl', 'rb'))
    
    # Load the saved standard scaler 
    scaler = pickle.load(open('/Users/akash/Desktop/Heart disease DL xray/tabular dataset/standardScaler1.pkl', 'rb'))
    authenticator.logout("Logout","sidebar")
    st.sidebar.title(f"Welcome {name}")
    st.title('Cardiomegaly Prediction🫀')
    ...
    if uploaded_file:
        ...
        print("Please Upload a X-Ray Image")
        pass
